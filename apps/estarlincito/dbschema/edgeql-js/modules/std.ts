...
> = $.$expr_Function<
  ...
  $.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type minλFuncExpr13<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>> =
  $.$expr_Function<
...
type minλFuncExpr14<
  P1 extends _.castMaps.orScalarLiteral<
    $.TypeSet<_cal.$local_datetimeλICastableTo>
  >,
> = $.$expr_Function<
  _cal.$local_datetime,
  $.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
...
type minλFuncExpr15<
  P1 extends _.castMaps.orScalarLiteral<
    $.TypeSet<_cal.$relative_durationλICastableTo>
  >,
> = $.$expr_Function<
  _cal.$relative_duration,
  $.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
 ...
 * Return the smallest value of the input set.
 */
function min<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>>(
  vals: P1,
): minλFuncExpr13<P1>;
/**
 * Return the smallest value of the input set.
...
function min(...args: any[]) {
  const {
    ...
    },
    {
      args: [
        {
          typeId: '3a39c464-a115-5b5e-8968-fb30b2c6a7a1',
          optional: false,
          setoftype: true,
          variadic: false,
        },
    ...
    },
    {
      args: [
        {
          typeId: '80d4b62c-e31c-51c6-b994-afaae5b6eff6',
          optional: false,
          setoftype: true,
          variadic: false,
        },
    ...
    },
    {
      args: [
        {
          typeId: 'd9d5e4a4-d545-5a03-a9da-571d8807619f',
          optional: false,
          setoftype: true,
          variadic: false,
        },
    ...
    },
    {
      args: [
        {
          typeId: '2417884d-4995-5a45-8c61-614adab347a7',
          optional: false,
          setoftype: true,
          variadic: false,
        },
    ...
    },
    {
      args: [
        {
          typeId: 'fd652c7f-67e3-516f-b508-c8e6f227311e',
          optional: false,
          setoftype: true,
          variadic: false,
        },
...
> = $.$expr_Function<
  ...
  $.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
>;
type maxλFuncExpr13<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>> =
  $.$expr_Function<
    $.ArrayType<_cal.$date_duration>,
    $.cardutil.overrideUpperBound<$.cardutil.paramCardinality<P1>, 'One'>
  >;
 ...
 * Return the smallest value of the input set.
 */
function max<P1 extends $.TypeSet<$.ArrayType<_cal.$date_duration>>>(
  vals: P1,
): maxλFuncExpr13<P1>;
/**
 * Return the smallest value of the input set.
...
function contains(...args: any[]) {
  const {
    ...
    },
    {
      args: [
        {
          typeId: '1e76d7c5-b67c-542c-bc8f-238b93ff1726',
          optional: false,
          setoftype: false,
          variadic: false,
        },
    ...
    },
    {
      args: [
        {
          typeId: 'e294f13d-34ee-529f-b7f8-7c3e2fd17e6e',
          optional: false,
          setoftype: false,
          variadic: false,
        },
...
type range_unpackλFuncExpr3<
  P1 extends $.TypeSet<$.RangeType<_cal.$local_date>>,
> = $.$expr_Function<_cal.$local_date, $.Cardinality.Many>;
...
type range_unpackλFuncExpr11<
  ...
  P2 extends _.castMaps.orScalarLiteral<
    $.TypeSet<_cal.$relative_durationλICastableTo>
  >,
> = $.$expr_Function<_cal.$local_datetime, $.Cardinality.Many>;
...
function range_unpack<P1 extends $.TypeSet<$.RangeType<_cal.$local_date>>>(
  val: P1,
...
function range_unpack(...args: any[]) {
  const {
    ...
    },
    {
      args: [
        {
          typeId: 'c4441320-c6b5-5f6a-95e4-0dd4aad4e49f',
          optional: false,
          setoftype: false,
          variadic: false,
        },
...
> = $.$expr_Function<$.RangeType<_cal.$local_datetime>, $.Cardinality.Many>;
type multirange_unpackλFuncExpr8<
  P1 extends $.TypeSet<$.MultiRangeType<_cal.$local_date>>,
> = $.$expr_Function<$.RangeType<_cal.$local_date>, $.Cardinality.Many>;
...
function multirange_unpack(...args: any[]) {
  const {
    ...
    },
    {
      args: [
        {
          typeId: '1990bea3-4cb3-5881-9641-8727f5d2af59',
          optional: false,
          setoftype: false,
          variadic: false,
        },
