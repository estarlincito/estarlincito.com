...
const me = [
  {
    principio: 'ʕ•ᴥ•ʔ',
    razon:
      'Este osito ʕ•ᴥ•ʔ, lo suelo utilizar para acordarme de que debo confiar en mí mismo más que en nadie, de que las cosas que me propongo las puedo lograr, para recordarme que vale la pena ser una buena persona a pesar de las cosas malas que me pasen en la vida... (amor propio).',
    id: 1,
  },
  {
    principio: 'me',
    razon:
      'La verdad, suelo usar "me" para trabajar en mi interior, es como una forma de mejorar en mi crecimiento personal, recordarme a mí mismo, felicitarme, regalarme un helado, recordarme que yo estoy primero en mi vida. (amor propio).',
    id: 2,
  },
  {
