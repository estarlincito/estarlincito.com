...
const Collapse = () => {
  ...
  return (
    <div className="relative">
      <div className="grid grid-cols-8 grid-rows-6 absolute w-[50vh] h-[90vh] bg-white  rounded-br-lg z-50 dark:bg-[#171616] dark:shadow-md dark:shadow-neutral-800">
        {/* close button */}
        <button
          onClick={handleClose}
          className="row-start-1 col-start-7 text-3xl text-neutral-900 hover:opacity-70 active:opacity-40 dark:text-neutral-50 m-5"
        >
          <MdClose />
        </button>
        {/* links */}
